    ...
    <div className="flex flex-col gap-8 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <Connected fallback={
        <div className="bg-zinc-900/50 border border-zinc-800 border-dashed rounded-[2.5rem] p-16 text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-black italic">CONNECT WALLET</h2>
            <p className="text-zinc-500 text-sm max-w-xs mx-auto">Authorize deployment permissions to access the clanker factory.</p>
          </div>
        </div>
      }>
        <div className="bg-gradient-to-br from-zinc-900/50 to-zinc-950 border border-zinc-800/80 rounded-[2.5rem] p-7 space-y-7 relative overflow-hidden backdrop-blur-3xl shadow-2xl">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1 space-y-3">
                <input 
                  ...
                  className="w-full bg-transparent text-2xl font-black italic placeholder-zinc-800 focus:outline-none uppercase tracking-tight"
                />
            ...
            <div className="space-y-6">
              <div className="relative">
                <textarea 
                  ...
                  className="w-full bg-zinc-950/30 border border-zinc-800/80 rounded-3xl p-5 text-sm font-medium focus:border-base-blue/50 transition-all h-32 resize-none placeholder:text-zinc-800 leading-relaxed"
                />
              ...
              <div className="bg-zinc-950/50 rounded-2xl p-5 border border-zinc-900/50 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3 bg-black rounded-xl px-4 py-2 border border-zinc-800/80">
                  <input 
                    ...
                    className="bg-transparent text-right w-20 text-sm font-black italic focus:outline-none"
                  />
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 px-1">
          {[
            { id: "1", name: "BASED_GOAT", ticker: "GOAT", time: "12s", mcap: "$420K", hash: "0x123", growth: "+45%" },
            { id: "2", name: "CLANKER_FAN", ticker: "CLANK", time: "45s", mcap: "$12K", hash: "0x456", growth: "+12%" },
          ].map((token, i) => (
            <div 
              key={token.id}
              className="bg-zinc-900/30 border border-zinc-900/50 rounded-3xl p-4 flex items-center justify-between group hover:border-base-blue/40 hover:bg-zinc-900/50 transition-all cursor-pointer"
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm font-black tracking-tight">{token.name} <span className="text-base-blue font-mono text-[10px] ml-1 uppercase">${token.ticker}</span></div>
                  <div className="text-[10px] font-bold text-zinc-600 mt-0.5">deployed {token.time} ago</div>
                </div>
              </div>
      ...
      <div className="mt-8 p-6 bg-base-blue/5 border border-base-blue/10 rounded-[2rem] flex items-center gap-5">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/95 backdrop-blur-3xl animate-in fade-in duration-300">
          <div className="bg-zinc-950 border border-zinc-900 rounded-[3rem] p-9 w-full max-w-sm space-y-7 shadow-3xl">
             ...
             <div className="text-center space-y-2">
                <h3 className="text-2xl font-black italic uppercase leading-none">FINAL CHECK</h3>
             ...
             <div className="grid grid-cols-2 gap-4 pt-2">
                ...
                <button 
                  ...
                  className="py-4 rounded-2xl bg-base-blue font-black text-sm italic shadow-2xl shadow-base-blue/20 active:scale-95 transition-all"
                >
                  DEPLOY 🚀
                </button>
             </div>
      ...
      {isDeploying && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/80 backdrop-blur-xl animate-in zoom-in-95 duration-500">
           <div className="flex flex-col items-center gap-8">
              ...
              <div className="text-center space-y-2">
                <p className="text-xl font-black italic uppercase tracking-tighter">Broadcasting...</p>
